...
run it to re-derive the fold table from
...
def cmd_bound():
    ...
    print("(matches the bound documented in sqr_mul.S)")
...
def cmd_gen_test():
    ...
    print("// shared bug would not hide itself. See scripts/p256_reduce_derivation.py.")
    print()
